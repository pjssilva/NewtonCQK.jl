...
# Extract Metis and rename folder to match Makefile in PPROJ
...
# Compile PPROJ
(cd PPROJ-1.0/SuiteSparse-4.4.7/SuiteSparse_config && make)
(cd PPROJ-1.0 && make SUITESPARSEDIR=SuiteSparse-4.4.7 BLAS="-lopenblas -lgfortran" LAPACK=-llapack)
